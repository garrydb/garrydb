...
namespace GarryDB.Specs.Platform.Plugins.Inspections.Extensions
{
    public class InspectedPluginAssertions : ReferenceTypeAssertions<InspectedPlugin, InspectedPluginAssertions>
    {
        private static readonly PropertyInfo assemblyProperty =
            typeof(InspectedAssembly).GetProperty("Assembly", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.GetProperty);
        ...
        public AndConstraint<InspectedPluginAssertions> HavePluginAssembly(
            Assembly assembly,
            string because = "",
        ...
        public AndConstraint<InspectedPluginAssertions> Provide(
            Assembly assembly,
            string because = "",
            params object[] becauseArgs
        )
        ...
        )
        {
            Execute.Assertion
                   ...
                   .Given(() => Subject
                                .ProvidedAssemblies
                                .Select(providedAssembly => (Assembly)assemblyProperty.GetValue(providedAssembly)))
        ...
        public AndConstraint<InspectedPluginAssertions> Reference(
            Assembly assembly,
            string because = "",
            params object[] becauseArgs
        )
        ...
        )
        {
            Execute.Assertion
                   ...
                   .Given(() => Subject
                                ...
                                .Select(referencedAssembly => (Assembly)assemblyProperty.GetValue(referencedAssembly)))
                   .ForCondition(assemblies => assemblies.Any(assembly => assembly.GetName().IsCompatibleWith(assemblyName)))
